...
(see [../pigment/RESEARCH.md §2](../pigment/RESEARCH.md)). Pulse's addition is a **time axis**: every node
...
shared render-graph node model and the `prism-doc` interchange container (see [../SUITE.md](../SUITE.md)).
